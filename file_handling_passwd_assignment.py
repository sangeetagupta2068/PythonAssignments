...
'''
    ...
    objective: This program retrieves and prints all the system users username from the /etc/passwd file on the console
               and writes the retrieved username on a file namely passwd_username.txt
